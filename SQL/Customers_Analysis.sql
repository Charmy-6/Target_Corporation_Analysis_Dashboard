...
-- How many unique cities contribute to the customer base --
SELECT COUNT(DISTINCT customer_city) AS unique_cities
FROM customers;

-- Which states use credit card payments the most --
...
-- Which states have the highest customer base and revenue --
SELECT c.customer_state,
...
-- Which states contribute the most revenue each year --
SELECT c.customer_state,
